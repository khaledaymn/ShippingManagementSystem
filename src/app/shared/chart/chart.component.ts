...
export class ChartComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    if (this.chartData.type === "line") {
      this.lineChartPathArea = this.getEnhancedLineChartPath(this.chartData, true)
      this.lineChartPathLine = this.getEnhancedLineChartPath(this.chartData, false)
      this.animatedDataPoints = this.getAnimatedDataPoints(this.chartData)
  ...
  private getEnhancedLineChartPath(chart: ChartData, isArea: boolean): string {
  ...
  private getAnimatedDataPoints(chart: ChartData): Array<{
    x: number
    y: number
    value: number
    month: number
