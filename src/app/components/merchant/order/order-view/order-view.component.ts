...
import { Order, OrderParams, OrderStateOptions, OrderTypeOptions, PaymentTypeOptions } from '../../../../core/models/order';
...
export class MerchantOrdersViewComponent implements OnInit, OnDestroy {
  ...
  private initializeForms(): void {
    ...
    this.assignMerchantForm = this.fb.group({
  ...
  private loadOrders(): void {
    this.loading = true;
    this.error = null;
   this.currentParams.merchantId = this.userId
  ...
  private viewDetails(orderId: number) {
    this.router.navigate(['merchant/orders/details', orderId]);
  }
  ...
  // Utility Methods
  onAdd(): void {
    this.router.navigate(['/merchant/orders/create']);
  }
